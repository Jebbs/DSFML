 ...
 *
 * See_Also:
 * http://www.sfml-dev.org/documentation/2.0/classsf_1_1Transformable.php#details
 */
 ...
 * Decomposed transform defined by a position, a rotation, and a scale.
 *
 * This template is provided for convenience, on top of Transformable
 * (and Transform).
 *
 * Transform, as a low-level class, offers a great level of flexibility but it
 * is not always convenient to manage. Indeed, one can easily combine any kind
 * of operation, such as a translation followed by a rotation followed by a
 ...
 * final transform.
 *
 * That's exactly what Transformable was written for: it hides these variables
 * and the composed transform behind an easy to use interface. You can set or
 * get any of the individual components without worrying about the others. It
 * also provides the composed transform (as a Transform), and keeps it
 * up-to-date.
 *
 * Authors: Laurent Gomila, Jeremy DeHaan
 *
